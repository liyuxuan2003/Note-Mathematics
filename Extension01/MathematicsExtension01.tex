    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}
                ...
                \tkzDefPoint(2.4,0.7){SA}
                \tkzDefPoint(3.7,1.5){SB}
                \tkzDefPoint(2.0,1.5){SC}
...
\subsubsection{三角形垂心的坐标表示}
    三角形垂心的坐标表示：\vspace{5pt}
    \begin{large}
        \begin{equation*}
