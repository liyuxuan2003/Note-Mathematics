            ...
            \subfigure[$\Delta>0$时的图像]
            {
                \begin{minipage}[t]{0.22\linewidth}
                    \begin{tikzpicture}[>=stealth,scale=0.4]
                        ...
                        \draw[cyan,smooth,thick,samples=100,domain=-2.3:2.3] 
                            plot(\x,{2*\x*\x-1});
                        \fill[black] (-0.721,0) circle (0.1);
                        \fill[black] (+0.721,0) circle (0.1);
                    \end{tikzpicture}
                \end{minipage}
            }\qquad
            ...
            \subfigure[满足（$a>0~~~~s>0$）]
            {
                \begin{minipage}[t]{0.18\linewidth}
                    \begin{tikzpicture}[>=stealth,scale=0.3]
                        ...
                        \draw[shift={(0,0)}] (0,0.1) -- (0,-0.1);
                        \draw[shift={(0,0)}] (0.1,0) -- (-0.1,0);
                        \draw[black,smooth,thick,samples=100,domain=-2.3:2.3]
                            plot(\x,{2*\x*\x+1});
                    \end{tikzpicture}
                \end{minipage}
            }\qquad
...
\newpage
    ...
    \begin{table}[h!]
        ...
        \end{center}
    \end{table}\\
    该情况下的解集，也可以代入$\Delta>0$时的解集公式中求解，可以得出相同的结论。\\[3mm]
    以上图像中，黑色部分代表在解集内，灰色部分代表在解集外。
            ...
            \subfigure[满足（$a>0~~~~s>0$）]
            {
                \begin{minipage}[t]{0.18\linewidth}
                    \begin{tikzpicture}[>=stealth,scale=0.3]
                        ...
                        \draw[shift={(0,0)}] (0,0.1) -- (0,-0.1);
                        \draw[shift={(0,0)}] (0.1,0) -- (-0.1,0);
                        \draw[black,smooth,thick,samples=100,domain=-2.3:-0.721]
                            plot(\x,{2*\x*\x-1});
                        \draw[black,smooth,thick,samples=100,domain=+0.721:+2.3]
                            plot(\x,{2*\x*\x-1});
                        \draw[gray,smooth,thick,samples=100,domain=-0.721:+0.721]
                            plot(\x,{2*\x*\x-1});
                        \fill[white] (-0.721,0) circle (0.2);
                        \fill[white] (+0.721,0) circle (0.2);
                        \draw[thin] (-0.721,0) circle (0.2);
                        \draw[thin] (+0.721,0) circle (0.2);
                    \end{tikzpicture}
                \end{minipage}
            }\qquad
                ...
                \begin{minipage}[t]{0.18\linewidth}
                    \begin{tikzpicture}[>=stealth,scale=0.3]
                        ...
                        \draw[gray,smooth,thick,samples=100,domain=+0.721:+2.3]
                            plot(\x,{2*\x*\x-1});
                        \draw[black,smooth,thick,samples=100,domain=-0.721:+0.721]
                            plot(\x,{2*\x*\x-1});
                        \fill[white] (-0.721,0) circle (0.2);
                        \fill[white] (+0.721,0) circle (0.2);
                        \draw[thin] (-0.721,0) circle (0.2);
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth]
                ...
                \fill[white] (2,0) circle (0.08);
                \fill[white] (4,0) circle (0.08);
                \fill[white] (6,0) circle (0.08);
                \fill[white] (8,0) circle (0.08);

                \draw[thin] (2,0) circle (0.08);
                \draw[thin] (4,0) circle (0.08);
                \draw[thin] (6,0) circle (0.08);
                \draw[thin] (8,0) circle (0.08);
...
\subsubsection{根的分布基本情况$1$}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \caption{根的分布基本情况$1$的示意图}
        \end{center}
    \end{figure}\\
    根的分布基本情况$1$的参数如下：\vspace{3pt}
    \begin{large}
        \begin{equation*}
            \begin{cases}
                ~~F(A)>0\\[1mm]
            ...
            \subfigure[焦点在$x$轴上的椭圆]
            {
                \begin{minipage}[t]{0.446\linewidth}
                    \begin{tikzpicture}[scale=0.7]
                        ...
                        \draw[cyan] (0,0) ellipse (3 and 2);

                        \fill(-2.236,0) circle(0.05);
                        \fill(+2.236,0) circle(0.05);
                        ...
                        \node at(-0.35,-2.4) {$B_1$};
                        \node at(-0.35,+2.4) {$B_2$};
                        \node at(-2.236,-0.40) {$F_1$};
                        \node at(+2.236,-0.40) {$F_2$};
                        \node at(-0.3,-0.3) {$O$};
                    \end{tikzpicture}
                \end{minipage}
            }\qquad
            \subfigure[焦点在$y$轴上的椭圆]
            {
                \begin{minipage}[t]{0.446\linewidth}
                    \begin{tikzpicture}[scale=0.7]
                        \draw[->] (-5,0) -- (5,0) node[above] {$x$};
                        \draw[->] (0,-5) -- (0,5) node[right] {$y$};
                        \draw[cyan] (0,0) ellipse (2 and 3);

                        \fill(0,-2.236) circle(0.05);
                        \fill(0,+2.236) circle(0.05);
                        ...
                        \node at(-0.35,-3.4) {$A_1$};
                        \node at(-0.35,+3.4) {$A_2$};
                        \node at(-0.35,-2.236) {$F_1$};
                        \node at(-0.35,+2.236) {$F_2$};
                        \node at(-0.3,-0.3) {$O$};
                    \end{tikzpicture}
                \end{minipage}
            }
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=0.7]
                ...
                \fill(-2.236,0) circle(0.05);
                \fill(+2.236,0) circle(0.05);
                \fill(+1,1.886) circle(0.05);

                \node at(-2.236,-0.40) {$F_1$};
                \node at(+2.236,-0.40) {$F_2$};

                \draw(+1,1.886)--(-2.236,0);
                \draw(+1,1.886)--(+2.236,0);
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                ...
                \fill[LightGray] (1.00,1.886) rectangle (0,0);
                \fill[LightGray] (1.80,1.600) rectangle (0,0);
                \fill[LightGray] (2.40,1.200) rectangle (0,0);
                \fill[LightGray] (2.80,0.718) rectangle (0,0);

                \draw[->] (-7,0) -- (7,0) node[above] {$x$};
                \draw[->] (0,-5) -- (0,5) node[right] {$y$};
                \draw[cyan] (0,0) ellipse (3 and 2);

                \draw[thin] (0.00,2.000) circle (0.05);
                \draw[thin] (1.00,1.886) circle (0.05);
                \draw[thin] (1.80,1.600) circle (0.05);
                \draw[thin] (2.40,1.200) circle (0.05);
                \draw[thin] (2.80,0.718) circle (0.05);
                \draw[thin] (3.00,0.000) circle (0.05);

                \draw (1.00,1.886)--(1.00,0);
                \draw (1.80,1.600)--(1.80,0);
                \draw (2.40,1.200)--(2.40,0);
                \draw (2.80,0.718)--(2.80,0);

                \draw (1.00,1.886)--(0,1.886);
                \draw (1.80,1.600)--(0,1.600);
                \draw (2.40,1.200)--(0,1.200);
                \draw (2.80,0.718)--(0,0.718); 

                \fill[white] (0.00,2.000) circle (0.05);
                \fill[white] (1.00,1.886) circle (0.05);
                \fill[white] (1.80,1.600) circle (0.05);
                \fill[white] (2.40,1.200) circle (0.05);
                \fill[white] (2.80,0.718) circle (0.05);
                \fill[white] (3.00,0.000) circle (0.05);
    ...
    \end{align}\\
    所构成的集合为椭圆的内部，将其代入标准方程即可得到$\dfrac{x^2}{a^2}+\dfrac{y^2}{b^2}<1$的条件。
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \fill[LightGray] (0.00,2.000) rectangle (4,3);
                \fill[LightGray] (1.00,1.886) rectangle (4,3);
                \fill[LightGray] (1.80,1.600) rectangle (4,3);
                \fill[LightGray] (2.40,1.200) rectangle (4,3);
                \fill[LightGray] (2.80,0.718) rectangle (4,3);
                \fill[LightGray] (3.00,0.000) rectangle (4,3);
                ...
                \draw (1.00,1.886)--(1.00,3);
                \draw (1.80,1.600)--(1.80,3);
                \draw (2.40,1.200)--(2.40,3);
                \draw (2.80,0.718)--(2.80,3);
                \draw (3.00,0.000)--(3.00,3);

                \draw (0.00,2.000)--(4,2.000);
                \draw (1.00,1.886)--(4,1.886);
                \draw (1.80,1.600)--(4,1.600);
                \draw (2.40,1.200)--(4,1.200);
                \draw (2.80,0.718)--(4,0.718);
...
\subsection{双曲线的方程}
    双曲线的定义：
    到平面上两个定点的距离差等于常数的点的轨迹称为双曲线。\\[2mm]
    其中定点$F_1$，定点$F_2$被称为焦点，
    而两个焦点间的距离$|F_1F_2|$被称为焦距。\\[6mm]
    如果设焦点$F_1(x_1,y_1),F_2(x_2,y_2)$，
    点到两焦点的距离差的绝对值为$2a$。\\[2mm]
    双曲线的方程：
    \begin{large}
        \begin{equation*}
            ...
            \subfigure[焦点在$x$轴上的双曲线]
            {
                \begin{minipage}[t]{0.446\linewidth}
                    \begin{tikzpicture}[scale=0.7]
                        \draw[->] (-5,0) -- (5,0) node[above] {$x$};
                        \draw[->] (0,-5) -- (0,5) node[right] {$y$};
                        \draw[cyan] plot[variable=\t,domain=-67:67] ({+1.5*sec(\t)},{+1.5*tan(\t)});
                        \draw[cyan] plot[variable=\t,domain=-67:67] ({-1.5*sec(\t)},{-1.5*tan(\t)});

                        \draw[MediumGray,dashed] (-4.5,-4.5)--(+4.5,+4.5);
                        \draw[MediumGray,dashed] (+4.5,-4.5)--(-4.5,+4.5);

                        \draw[MediumGray,dashed] (-1.5,+1.5)--(-1.5,-1.5);
                        \draw[MediumGray,dashed] (+1.5,+1.5)--(+1.5,-1.5);
                        \draw[MediumGray,dashed] (-1.5,+1.5)--(+1.5,+1.5);
                        \draw[MediumGray,dashed] (-1.5,-1.5)--(+1.5,-1.5);

                        \fill(-2.121,0) circle(0.05);
                        \fill(+2.121,0) circle(0.05);
                        ...
                        \node at(-0.35,-1.8) {$B_1$};
                        \node at(-0.35,+1.8) {$B_2$};
                        \node at(-2.121,-0.40) {$F_1$};
                        \node at(+2.121,-0.40) {$F_2$};
                    \end{tikzpicture}
                \end{minipage}
            }\qquad
            \subfigure[焦点在$y$轴上的双曲线]
            {
                \begin{minipage}[t]{0.446\linewidth}
                    \begin{tikzpicture}[scale=0.7]
                        \draw[->] (-5,0) -- (5,0) node[above] {$x$};
                        \draw[->] (0,-5) -- (0,5) node[right] {$y$};
                        \draw[cyan] plot[variable=\t,domain=-67:67] ({+1.5*tan(\t)},{+1.5*sec(\t)});
                        \draw[cyan] plot[variable=\t,domain=-67:67] ({-1.5*tan(\t)},{-1.5*sec(\t)});
                        ...
                        \node at(-1.8,-0.4) {$B_1$};
                        \node at(+1.8,-0.4) {$B_2$};
                        \node at(-0.35,-2.121) {$F_1$};
                        \node at(-0.35,+2.121) {$F_2$};
                    \end{tikzpicture}
                \end{minipage}
            }
            \caption{双曲线的图像}
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=0.7]
                \draw[->] (-5,0) -- (5,0) node[above] {$x$};
                \draw[->] (0,-3.5) -- (0,3.5) node[right] {$y$};
                \draw[cyan] plot[variable=\t,domain=-65:65] ({+1.5*sec(\t)},{+1.5*tan(\t)});
                \draw[cyan] plot[variable=\t,domain=-65:65] ({-1.5*sec(\t)},{-1.5*tan(\t)});

                \fill(-2.121,0) circle(0.05);
                \fill(+2.121,0) circle(0.05);
                \fill(+2,+1.323) circle(0.05);

                \node at(-2.121,-0.40) {$F_1$};
                \node at(+2.121,-0.40) {$F_2$};

                \draw(+2,1.323)--(-2.121,0);
                \draw(+2,1.323)--(+2.121,0);
...
\subsubsection{双曲线和点的关系}
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=0.7]
                ...
                \fill(1.50,0) circle(0.05);
                \fill(3.00,0) circle(0.05);
    ...
    \begin{large}
        ...
        \end{equation*}
    \end{large}\\
    在示意图中，点$A$是在双曲线内，点$B$是在双曲线上，点$C$是在双曲线外。
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \fill[LightGray] (1.500,0.000) rectangle (4,0);
                \fill[LightGray] (1.750,0.901) rectangle (4,0);
                \fill[LightGray] (2.000,1.323) rectangle (4,0);
                \fill[LightGray] (2.500,2.000) rectangle (4,0);
                \fill[LightGray] (3.000,2.598) rectangle (4,0);
                \fill[LightGray] (3.354,3.000) rectangle (4,0);

                \fill[white] (1.500,0.000) circle (0.05);
                \fill[white] (1.750,0.901) circle (0.05);
                \fill[white] (2.000,1.323) circle (0.05);
                \fill[white] (2.500,2.000) circle (0.05);
                \fill[white] (3.000,2.598) circle (0.05);
                \fill[white] (3.354,3.000) circle (0.05);
                ...
                \draw[thin] (1.500,0.000) circle (0.05);
                \draw[thin] (1.750,0.901) circle (0.05);
                \draw[thin] (2.000,1.323) circle (0.05);
                \draw[thin] (2.500,2.000) circle (0.05);
                \draw[thin] (3.000,2.598) circle (0.05);
                \draw[thin] (3.354,3.000) circle (0.05);

                \draw (1.500,0.000)--(4.00,0.000);
                \draw (1.750,0.901)--(4.00,0.901);
                \draw (2.000,1.323)--(4.00,1.323);
                \draw (2.500,2.000)--(4.00,2.000);
                \draw (3.000,2.598)--(4.00,2.598);
                \draw (3.354,3.000)--(4.00,3.000);

                \draw (1.750,0.901)--(1.750,0.00);
                \draw (2.000,1.323)--(2.000,0.00);
                \draw (2.500,2.000)--(2.500,0.00);
                \draw (3.000,2.598)--(3.000,0.00);
                \draw (3.354,3.000)--(3.354,0.00);
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \fill[LightGray] (1.500,0.000) rectangle (0,3);
                \fill[LightGray] (1.750,0.901) rectangle (0,3);
                \fill[LightGray] (2.000,1.323) rectangle (0,3);
                \fill[LightGray] (2.500,2.000) rectangle (0,3);
                \fill[LightGray] (3.000,2.598) rectangle (0,3);
                \fill[LightGray] (3.354,3.000) rectangle (0,3);
                ...
                \draw (1.750,0.901)--(0.000,0.901);
                \draw (2.000,1.323)--(0.000,1.323);
                \draw (2.500,2.000)--(0.000,2.000);
                \draw (3.000,2.598)--(0.000,2.598);
                \draw (3.354,3.000)--(0.000,3.000);

                \draw (1.500,0.000)--(1.500,3.000);
                \draw (1.750,0.901)--(1.750,3.000);
                \draw (2.000,1.323)--(2.000,3.000);
                \draw (2.500,2.000)--(2.500,3.000);
                \draw (3.000,2.598)--(3.000,3.000);
...
\subsection{抛物线的方程}
    抛物线的定义：到平面上一个定点和一条定直线的距离相等的点的轨迹称为抛物线。\\[2mm]
    其中定点$F$被称为焦点，而定直线被称为准线。\\[6mm]
    设焦点$F(x_0,y_0)$，准线$l:ax+by+c=0$。\\[2mm]
    抛物线的方程：
    \begin{large}
        \begin{equation*}
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
                ...
                \draw[shift={(0,0)}] (0,0.1) -- (0,-0.1);
                \draw[shift={(0,0)}] (0.1,0) -- (-0.1,0);
                \draw[cyan] plot[variable=\t,domain=-3.2:0] ({\t},{-0.5*\t^2});
                \draw[cyan] plot[variable=\t,domain=0:+3.2] ({\t},{0.5*\t^2});
            \end{tikzpicture}
            \caption{抛物线的图像}
        \end{center}
    \end{figure}\\
...
\newpage
    ...
    \begin{figure}[h!]
            ...
            \subfigure[焦点在$x$轴上的抛物线]
            {
                \begin{minipage}[t]{0.446\linewidth}
                    \begin{tikzpicture}[scale=0.7]
                        ...
                        \draw[cyan] plot[variable=\t,domain=-1.5:+1.5] ({2*\t*\t},{\t});
        ...
        \end{center}
    \end{figure}\\
    焦准距$p$可以取正可以取负，其正负表征了焦点和准线位置的相对关系。
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \fill[LightGray] (0.50,0.500) rectangle (4.5,0);
                \fill[LightGray] (1.50,0.866) rectangle (4.5,0);
                \fill[LightGray] (2.50,1.118) rectangle (4.5,0);
                \fill[LightGray] (3.50,1.323) rectangle (4.5,0);

                \draw[->] (-7,0) -- (7,0) node[above] {$x$};
                \draw[->] (0,-5) -- (0,5) node[right] {$y$};
                \draw[cyan] plot[variable=\t,domain=-1.5:+1.5] ({2*\t*\t},{\t});

                \draw[thin] (0.00,0.000) circle (0.05);
                \draw[thin] (0.50,0.500) circle (0.05);
                \draw[thin] (1.50,0.866) circle (0.05);
                \draw[thin] (2.50,1.118) circle (0.05);
                \draw[thin] (3.50,1.323) circle (0.05);
                \draw[thin] (4.50,1.500) circle (0.05);

                % \draw (0.00,0.000)--(4.5,0.500);
                \draw (0.50,0.500)--(4.5,0.500);
                \draw (1.50,0.866)--(4.5,0.866);
                \draw (2.50,1.118)--(4.5,1.118);
                \draw (3.50,1.323)--(4.5,1.323);
                % \draw (4.50,1.500)--(4.5,1.500);

                % \draw (0.00,0.000)--(4.5,0.500);
                \draw (0.50,0.500)--(0.50,0);
                \draw (1.50,0.866)--(1.50,0);
                \draw (2.50,1.118)--(2.50,0);
                \draw (3.50,1.323)--(3.50,0);
                % \draw (4.50,1.500)--(4.5,1.500);

                \draw[dashed] (-4.5,-2.5)rectangle (+4.5,+2.5);

                \fill[white] (0.00,0.000) circle (0.05);
                \fill[white] (0.50,0.500) circle (0.05);
                \fill[white] (1.50,0.866) circle (0.05);
                \fill[white] (2.50,1.118) circle (0.05);
                \fill[white] (3.50,1.323) circle (0.05);
                \fill[white] (4.50,1.500) circle (0.05);
            \end{tikzpicture}
            \caption{点在抛物线内时的示意图}
        \end{center}
    \end{figure}\\
    对于抛物线上任意一点$(x_0,y_0)$，则平面上任意满足下列不等式的一点$(x,y)$：\vspace{5pt}
    \setcounter{equation}{0}
    \begin{align}
        &\begin{cases}
            x\geq x_0\\[1mm]
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \begin{tikzpicture}[scale=1.0]
                \fill[LightGray] (0.50,0.500) rectangle (0,2.5);
                \fill[LightGray] (1.50,0.866) rectangle (0,2.5);
                \fill[LightGray] (2.50,1.118) rectangle (0,2.5);
                \fill[LightGray] (3.50,1.323) rectangle (0,2.5);
                \fill[LightGray] (4.50,1.500) rectangle (0,2.5);
                ...
                \draw (0.50,0.500)--(0,0.500);
                \draw (1.50,0.866)--(0,0.866);
                \draw (2.50,1.118)--(0,1.118);
                \draw (3.50,1.323)--(0,1.323);
                \draw (4.50,1.500)--(0,1.500);

                \draw (0.50,0.500)--(0.50,2.5);
                \draw (1.50,0.866)--(1.50,2.5);
                \draw (2.50,1.118)--(2.50,2.5);
                \draw (3.50,1.323)--(3.50,2.5);
                \draw (4.50,1.500)--(4.50,2.5);
...
\newpage
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
                \draw[fill=gray] (-4.3,0.3) rectangle(-3.7,-0.3);
                \draw[fill=gray] (-3.3,0.3) rectangle(-2.7,-0.3);
                \draw[fill=gray] (-2.3,0.3) rectangle(-1.7,-0.3);
                \draw[fill=gray] (-1.3,0.3) rectangle(-0.7,-0.3);
        ...
        \end{center}
    \end{figure}\\
    在$4$个约束元素中，保留$4$个在排斥位上，共有$\mathrm{C}_4^4$种组合，即$\mathrm{C}_x^{x-0}$。\\[3mm]
    在$4$个约束元素中，移出$0$个至普通位上，共有$\mathrm{P}_5^0\,$种排列，即$\mathrm{P}_n^{0}$。\\[3mm]
    对于$5$个普通元素，剩余$5$个空位，共有$\mathrm{P}_5^5$种排列，即$\mathrm{P}_n^n$。\\[10mm]
    当循环变量$i=1$时：
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
        ...
        \end{center}
    \end{figure}\\
    在$4$个约束元素中，保留$3$个在排斥位上，共有$\mathrm{C}_4^3$种组合，即$\mathrm{C}_x^{x-1}$。\\[3mm]
    在$4$个约束元素中，移出$1$个至普通位上，共有$\mathrm{P}_5^1\,$种排列，即$\mathrm{P}_n^{1}$。\\[3mm]
    对于$5$个普通元素，剩余$5$个空位，共有$\mathrm{P}_5^5$种排列，即$\mathrm{P}_n^n$。
...
\newpage
    ...
    \begin{figure}[h]
        ...
        \end{center}
    \end{figure}\\
    在$4$个约束元素中，保留$2$个在排斥位上，共有$\mathrm{C}_4^2$种组合，即$\mathrm{C}_x^{x-2}$。\\[3mm]
    在$4$个约束元素中，移出$2$个至普通位上，共有$\mathrm{P}_5^2\,$种排列，即$\mathrm{P}_n^{2}$。\\[3mm]
    对于$5$个普通元素，剩余$5$个空位，共有$\mathrm{P}_5^5$种排列，即$\mathrm{P}_n^n$。\\[10mm]
    当循环变量$i=3$时：
    \begin{figure}[h]
        \begin{center}
        ...
        \end{center}
    \end{figure}\\
    在$4$个约束元素中，保留$1$个在排斥位上，共有$\mathrm{C}_4^1$种组合，即$\mathrm{C}_x^{x-3}$。\\[3mm]
    在$4$个约束元素中，移出$3$个至普通位上，共有$\mathrm{P}_5^3\,$种排列，即$\mathrm{P}_n^{3}$。\\[3mm]
    对于$5$个普通元素，剩余$5$个空位，共有$\mathrm{P}_5^5$种排列，即$\mathrm{P}_n^n$。\\[10mm]
...
\newpage
    ...
    \begin{figure}[h]
        ...
        \end{center}
    \end{figure}\\
    在$5$个约束元素中，保留$5$个在排斥位上，共有$\mathrm{C}_5^5$种组合，即$\mathrm{C}_x^{x-0}$。\\[3mm]
    在$5$个约束元素中，移出$0$个至普通位上，共有$\mathrm{P}_3^0\,$种排列，即$\mathrm{P}_n^{0}$。\\[3mm]
    对于$3$个普通元素，剩余$3$个空位，共有$\mathrm{P}_3^3$种排列，即$\mathrm{P}_n^n$。\\[10mm]
    当循环变量$i=1$时：
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
        ...
        \end{center}
    \end{figure}\\
    在$5$个约束元素中，保留$4$个在排斥位上，共有$\mathrm{C}_5^4$种组合，即$\mathrm{C}_x^{x-1}$。\\[3mm]
    在$5$个约束元素中，移出$1$个至普通位上，共有$\mathrm{P}_3^1\,$种排列，即$\mathrm{P}_n^{1}$。\\[3mm]
    对于$3$个普通元素，剩余$3$个空位，共有$\mathrm{P}_3^3$种排列，即$\mathrm{P}_n^n$。\\[8mm]
...
\newpage
    ...
    \begin{figure}[h]
        ...
        \end{center}
    \end{figure}\\
    在$5$个约束元素中，保留$3$个在排斥位上，共有$\mathrm{C}_5^3$种组合，即$\mathrm{C}_x^{x-2}$。\\[3mm]
    在$5$个约束元素中，移出$2$个至普通位上，共有$\mathrm{P}_2^3\,$种排列，即$\mathrm{P}_n^{2}$。\\[3mm]
    对于$3$个普通元素，剩余$3$个空位，共有$\mathrm{P}_3^3$种排列，即$\mathrm{P}_n^n$。\\[10mm]
    当循环变量$i=3$时：
    \begin{figure}[h]
        \begin{center}
        ...
        \end{center}
    \end{figure}\\
    在$5$个约束元素中，保留$2$个在排斥位上，共有$\mathrm{C}_5^2$种组合，即$\mathrm{C}_x^{x-3}$。\\[3mm]
    在$5$个约束元素中，移出$3$个至普通位上，共有$\mathrm{P}_3^3\,$种排列，即$\mathrm{P}_n^{3}$。\\[3mm]
    对于$3$个普通元素，剩余$3$个空位，共有$\mathrm{P}_3^3$种排列，即$\mathrm{P}_n^n$。\\[10mm]
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
                ...
                \node at(+2,0) {$n_3$};
                \node at(+3,0) {$n_4$};
                \draw (-3.3,0.3) rectangle(-0.7,-0.3);
            \end{tikzpicture}
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
                ...
                \draw (-1.3,0.3) rectangle(-0.7,-0.3);
                \node at(+0,0) {$n_2$};
                \draw (+0.7,0.3) rectangle(+1.3,-0.3);
                \node at(+2,0) {$n_3$};
                \draw (+2.7,0.3) rectangle(+3.3,-0.3);                
            \end{tikzpicture}
...
\subsubsection{排列组合问题\rnum{3}-$03$}
    排列组合问题\rnum{3}-$03$背景：将$n$个\textbf{相同的}球放入$m$个\textbf{不同的}盒中，保证盒$m_i$个中至少$x_i$个。\\[3mm]
    排列组合问题\rnum{3}-$03$背景：
    \begin{large}
        \begin{equation*}
            P=\mathrm{C}_{n-\sum_{i=1}^m[x_i-1]-1}^{m-1}
        \end{equation*}
    \end{large}\\
    可以以插板的思路解决该问题：\vspace{3pt}
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}[>=stealth,scale=1.0]
                \draw (-3,0) circle(0.2);
                ...
                \draw[ultra thick] (-3.5,+0.4)--(-3.5,-0.4);
                \draw[ultra thick] (-1.5,+0.4)--(-1.5,-0.4);
                \draw[ultra thick] (+2.5,+0.4)--(+2.5,-0.4);
                \draw[ultra thick] (+3.5,+0.4)--(+3.5,-0.4);
                ...
                \draw[very thick] (4.3,-0.3)--(5.7,-0.3);
                \draw[very thick] (6.3,-0.3)--(7.7,-0.3);
                \draw[very thick] (8.3,-0.3)--(9.7,-0.3);

                \draw[very thick] (4.3,-0.3)--(4.3,+0.2);
                \draw[very thick] (5.7,-0.3)--(5.7,+0.2);
                \draw[very thick] (6.3,-0.3)--(6.3,+0.2);
                \draw[very thick] (7.7,-0.3)--(7.7,+0.2);
                \draw[very thick] (8.3,-0.3)--(8.3,+0.2);
                \draw[very thick] (9.7,-0.3)--(9.7,+0.2);

                \draw (5.3,0) circle(0.2);
                \draw (7.3,0) circle(0.2);
                \draw (9.3,0) circle(0.2);
